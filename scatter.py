...
#scatterplot
    ...
    Over = plt.scatter(-f1(fc2[0]),f1(fdr2[0]),color='green')
    ...
    for i in range (len(fc2[0])):
        if f1(fdr2[0][i])>4.321928:
            ...
            #plt.annotate(sorted_df.loc[i,'PANTHER GO-Slim Biological Process]',(-f1(fc2[0][i]),f1(fdr2[0][i])))
    Under = plt.scatter(-f1(fc2[1]),f1(fdr2[1]),color='grey')
    ...
    plt.axhline(y=4.321928,color='black')
